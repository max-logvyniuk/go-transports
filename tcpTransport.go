...
/** Receive connection and map with routes and appropriate function handler*/
func handleConnection(conn net.Conn) {
	...
	/** @ is separator for message_length, pattern and options in meta data*/
...
func router(conn net.Conn, parsedRequest reqEncoded) {
	...
	// TODO: comment or remove and publish package
	...
	*/
	...
	if useDefaultPattern {
		conn.Write([]byte("Unknown pattern"))
	}
}
